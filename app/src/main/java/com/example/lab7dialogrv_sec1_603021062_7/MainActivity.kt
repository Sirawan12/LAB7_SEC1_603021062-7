...
class MainActivity : AppCompatActivity() {
    ...
    fun testStudentData() {
        studentList.add(Student("603021062-7", "Sirawan Thonglor", 21))
        studentList.add(Student("603021736-0", "Usani Boonnoon", 21))
        studentList.add(Student("603020802-8", "Wanjaeng Pongphat", 21))
    }
}
